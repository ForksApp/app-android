...
var templates = {
    ...
    promotionsViewTemplate:"views/promotionsViewTemplate.html",
...
ViewAssembler.prototype.defaultView = function() {
    ...
    el.find("#promotions").on( this.CLICK_EVENT, onPromotionsViewClick);
...
ViewAssembler.prototype.promotionsView = function() {
    var el = $( templates.promotionsViewTemplate );
    return el;
}
